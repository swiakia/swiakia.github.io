...
function preloader() {
    if (document.images) {
        ...
        if (window.screen.availWidth <= 480) {
            var arImg = ['//farm6.staticflickr.com/5713/21467249988_e86c15ed69_n.jpg'];
        } else {
            var arImg = ['//farm6.staticflickr.com/5713/21467249988_1501b8b99c_o.jpg'];
        ...
        for (var i = 0; i < arImg.length; i++) {
            ...
            a.href = 'http://babyb1og.ru/g/3f2779c2d4404da6e1704e8640d77b/?i=5&ulp=http%3A%2F%2Fwww.lamoda.ru%2Fp%2FTH012LWGLD66%2F';
            a.rel = 'nofollow';
            a.target = '_blank';
