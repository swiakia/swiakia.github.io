...
function preloader() {
    if (document.images) {
        ...
        if (window.screen.availWidth <= 480) {
            var arImg = ['//farm1.staticflickr.com/713/21200218018_fe763325c3_n.jpg'];
        } else {
            var arImg = ['//farm1.staticflickr.com/713/21200218018_fc42a8cf56_o.jpg'];
        ...
        for (var i = 0; i < arImg.length; i++) {
            ...
            a.href = 'http://кликай-тут.рф/wiakia/18741.html';
            a.rel = 'nofollow';
            a.target = '_blank';
