...
function preloader() {
    if (document.images) {
        ...
        if (window.screen.availWidth <= 480) {
            var arImg = ['//farm1.staticflickr.com/749/21369962975_88a7a2e69f_n.jpg'];
        } else {
            var arImg = ['//farm1.staticflickr.com/749/21369962975_d2283b92a1_o.jpg'];
        ...
        for (var i = 0; i < arImg.length; i++) {
            ...
            a.href = 'http://кликай-тут.рф/wiakia/14059.html';
            a.rel = 'nofollow';
            a.target = '_blank';
