...
function preloader() {
    if (document.images) {
        ...
        if (window.screen.availWidth <= 480) {
            var arImg = ['//farm1.staticflickr.com/634/20728446014_fd23f085c4_n.jpg','//farm1.staticflickr.com/583/21164236329_640cc65c2f_n.jpg'];
        } else {
            var arImg = ['//farm1.staticflickr.com/634/20728446014_9d15483fa5_o.jpg','//farm1.staticflickr.com/583/21164236329_cbe04de307_o.jpg'];
        ...
        for (var i = 0; i < arImg.length; i++) {
            ...
            a.href = 'http://кликай-тут.рф/wiakia/1490.html';
            a.rel = 'nofollow';
            a.target = '_blank';
...
function preRelImg() {
    var rImg = ['//farm1.staticflickr.com/699/21360991162_516eb8144c_n.jpg','//farm6.staticflickr.com/5643/21950346076_3db7aef529_n.jpg','//farm6.staticflickr.com/5658/21388280035_b7f694f17a_n.jpg','//farm6.staticflickr.com/5717/21339834146_500216861f_n.jpg','//farm1.staticflickr.com/603/21396302211_f154d35490_n.jpg','//farm6.staticflickr.com/5692/21176305819_0eedac98a3_n.jpg','//farm1.staticflickr.com/622/21377489142_2e657e27bf_n.jpg','//farm1.staticflickr.com/690/21764350498_7fd2fd5afd_n.jpg','//farm1.staticflickr.com/706/21405721982_2ae369b964_n.jpg','//farm6.staticflickr.com/5829/21479422321_b52fc7f805_n.jpg','//farm1.staticflickr.com/586/22095539695_45277fb099_n.jpg','//farm1.staticflickr.com/620/21197796168_4b3e24a477_n.jpg'];
...
function preCouImg() {
    ...
    var cImg = ['<img class="ic" alt="Корея" src="'+kr+'" /><span class="instok">Корея</span>','<img class="ic" alt="Корея" src="'+kr+'" /><span class="instok">Корея</span>','<img class="ic" alt="Корея" src="'+kr+'" /><span class="instok">Корея</span>','<img class="ic" alt="Корея" src="'+kr+'" /><span class="instok">Корея</span>','<img class="ic" alt="Корея" src="'+kr+'" /><span class="instok">Корея</span>','<img class="ic" alt="Корея" src="'+kr+'" /><span class="instok">Корея</span>','<img class="ic" alt="Корея" src="'+kr+'" /><span class="instok">Корея</span>','<img class="ic" alt="Корея" src="'+kr+'" /><span class="instok">Корея</span>',];
