...
function preloader() {
    if (document.images) {
        ...
        if (window.screen.availWidth <= 480) {
            var arImg = ['//farm1.staticflickr.com/760/21178492570_2793677cd3_n.jpg'];
        } else {
            var arImg = ['//farm1.staticflickr.com/760/21178492570_37c3562db5_o.jpg'];
        ...
        for (var i = 0; i < arImg.length; i++) {
            ...
            a.href = 'http://кликай-тут.рф/wiakia/12244.html';
            a.rel = 'nofollow';
            a.target = '_blank';
