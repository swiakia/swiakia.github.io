...
function preloader() {
    if (document.images) {
        ...
        if (window.screen.availWidth <= 480) {
            var arImg = ['//farm6.staticflickr.com/5783/21369184612_d453216a44_n.jpg'];
        } else {
            var arImg = ['//farm6.staticflickr.com/5783/21369184612_60e1a78c56_o.jpg'];
        ...
        for (var i = 0; i < arImg.length; i++) {
            ...
            a.href = 'http://кликай-тут.рф/wiakia/16877.html';
            a.rel = 'nofollow';
            a.target = '_blank';
