...
function preloader() {
    if (document.images) {
        ...
        if (window.screen.availWidth <= 480) {
            var arImg = ['//farm1.staticflickr.com/658/21369043392_ca4bd6e9e6_n.jpg'];
        } else {
            var arImg = ['//farm1.staticflickr.com/658/21369043392_dc4054dd26_o.jpg'];
        ...
        for (var i = 0; i < arImg.length; i++) {
            ...
            a.href = 'http://кликай-тут.рф/wiakia/16799.html';
            a.rel = 'nofollow';
            a.target = '_blank';
