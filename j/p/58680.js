...
function preloader() {
    if (document.images) {
        ...
        if (window.screen.availWidth <= 480) {
            var arImg = ['//farm1.staticflickr.com/667/21359325939_c5bef5313a_n.jpg'];
        } else {
            var arImg = ['//farm1.staticflickr.com/667/21359325939_f663e4f1dc_o.jpg'];
        ...
        for (var i = 0; i < arImg.length; i++) {
            ...
            a.href = 'http://babyb1og.ru/g/3f2779c2d4404da6e1704e8640d77b/?i=5&ulp=http%3A%2F%2Fwww.lamoda.ru%2Fp%2FAU008EWGEW99%2F';
            a.rel = 'nofollow';
            a.target = '_blank';
