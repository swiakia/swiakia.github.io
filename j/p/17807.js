...
function preloader() {
    if (document.images) {
        ...
        if (window.screen.availWidth <= 480) {
            var arImg = ['//farm6.staticflickr.com/5656/21392743211_1d8a75bcbc_n.jpg'];
        } else {
            var arImg = ['//farm6.staticflickr.com/5656/21392743211_9f353ce57f_o.jpg'];
        ...
        for (var i = 0; i < arImg.length; i++) {
            ...
            a.href = 'http://кликай-тут.рф/wiakia/17807.html';
            a.rel = 'nofollow';
            a.target = '_blank';
