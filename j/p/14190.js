...
function preloader() {
    if (document.images) {
        ...
        if (window.screen.availWidth <= 480) {
            var arImg = ['//farm1.staticflickr.com/641/21379421291_f8dae225c4_n.jpg'];
        } else {
            var arImg = ['//farm1.staticflickr.com/641/21379421291_59faa8e298_o.jpg'];
        ...
        for (var i = 0; i < arImg.length; i++) {
            ...
            a.href = 'http://кликай-тут.рф/wiakia/14190.html';
            a.rel = 'nofollow';
            a.target = '_blank';
