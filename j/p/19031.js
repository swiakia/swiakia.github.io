...
function preloader() {
    if (document.images) {
        ...
        if (window.screen.availWidth <= 480) {
            var arImg = ['//farm6.staticflickr.com/5734/21202638169_75735a5551_n.jpg'];
        } else {
            var arImg = ['//farm6.staticflickr.com/5734/21202638169_a370fa41f9_o.jpg'];
        ...
        for (var i = 0; i < arImg.length; i++) {
            ...
            a.href = 'http://кликай-тут.рф/wiakia/19031.html';
            a.rel = 'nofollow';
            a.target = '_blank';
