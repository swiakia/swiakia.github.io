...
function preloader() {
    if (document.images) {
        ...
        if (window.screen.availWidth <= 480) {
            var arImg = ['//farm6.staticflickr.com/5755/20759160594_101229124d_n.jpg','//farm6.staticflickr.com/5821/21355621466_4012fcda07_n.jpg'];
        } else {
            var arImg = ['//farm6.staticflickr.com/5755/20759160594_ee32d0ddd3_o.jpg','//farm6.staticflickr.com/5821/21355621466_0a4c58eb00_o.jpg'];
        ...
        for (var i = 0; i < arImg.length; i++) {
            ...
            a.href = 'http://кликай-тут.рф/wiakia/17443.html';
            a.rel = 'nofollow';
            a.target = '_blank';
