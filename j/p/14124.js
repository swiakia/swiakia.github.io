...
function preloader() {
    if (document.images) {
        ...
        if (window.screen.availWidth <= 480) {
            var arImg = ['//farm1.staticflickr.com/747/21183913839_ff7c2dd265_n.jpg'];
        } else {
            var arImg = ['//farm1.staticflickr.com/747/21183913839_14ab5da208_o.jpg'];
        ...
        for (var i = 0; i < arImg.length; i++) {
            ...
            a.href = 'http://кликай-тут.рф/wiakia/14124.html';
            a.rel = 'nofollow';
            a.target = '_blank';
