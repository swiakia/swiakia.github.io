...
function preloader() {
    if (document.images) {
        ...
        if (window.screen.availWidth <= 480) {
            var arImg = ['//farm6.staticflickr.com/5745/21361947836_ab75df7366_n.jpg'];
        } else {
            var arImg = ['//farm6.staticflickr.com/5745/21361947836_c063648cb3_o.jpg'];
        ...
        for (var i = 0; i < arImg.length; i++) {
            ...
            a.href = 'http://кликай-тут.рф/wiakia/18752.html';
            a.rel = 'nofollow';
            a.target = '_blank';
