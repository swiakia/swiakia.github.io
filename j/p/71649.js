...
function preloader() {
    if (document.images) {
        ...
        if (window.screen.availWidth <= 480) {
            var arImg = ['//farm1.staticflickr.com/676/21601272742_56c2c8dba7_n.jpg'];
        } else {
            var arImg = ['//farm1.staticflickr.com/676/21601272742_d8b0dbf23f_o.jpg'];
        ...
        for (var i = 0; i < arImg.length; i++) {
            ...
            a.href = 'http://babyb1og.ru/g/3f2779c2d4404da6e1704e8640d77b/?i=5&ulp=http%3A%2F%2Fwww.lamoda.ru%2Fp%2FVI005EWGCN37%2F';
            a.rel = 'nofollow';
            a.target = '_blank';
