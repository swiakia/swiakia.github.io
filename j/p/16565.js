...
function preloader() {
    if (document.images) {
        ...
        if (window.screen.availWidth <= 480) {
            var arImg = ['//farm6.staticflickr.com/5620/21387446431_30d3207620_n.jpg'];
        } else {
            var arImg = ['//farm6.staticflickr.com/5620/21387446431_b85af36670_o.jpg'];
        ...
        for (var i = 0; i < arImg.length; i++) {
            ...
            a.href = 'http://кликай-тут.рф/wiakia/16565.html';
            a.rel = 'nofollow';
            a.target = '_blank';
