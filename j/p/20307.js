...
function preloader() {
    if (document.images) {
        ...
        if (window.screen.availWidth <= 480) {
            var arImg = ['//farm6.staticflickr.com/5697/21205787838_46e5a5db2a_n.jpg','//farm6.staticflickr.com/5774/21205792878_fe667533c8_n.jpg'];
        } else {
            var arImg = ['//farm6.staticflickr.com/5697/21205787838_b99e8be2be_o.jpg','//farm6.staticflickr.com/5774/21205792878_dbd34881e8_o.jpg'];
        ...
        for (var i = 0; i < arImg.length; i++) {
            ...
            a.href = 'http://кликай-тут.рф/wiakia/20307.html';
            a.rel = 'nofollow';
            a.target = '_blank';
