...
function preloader() {
    if (document.images) {
        ...
        if (window.screen.availWidth <= 480) {
            var arImg = ['//farm1.staticflickr.com/606/20750651373_6acab4c350_n.jpg'];
        } else {
            var arImg = ['//farm1.staticflickr.com/606/20750651373_2cfb11b0a3_o.jpg'];
        ...
        for (var i = 0; i < arImg.length; i++) {
            ...
            a.href = 'http://кликай-тут.рф/wiakia/14414.html';
            a.rel = 'nofollow';
            a.target = '_blank';
