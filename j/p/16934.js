...
function preloader() {
    if (document.images) {
        ...
        if (window.screen.availWidth <= 480) {
            var arImg = ['//farm6.staticflickr.com/5748/21369364582_546f7dbda2_n.jpg'];
        } else {
            var arImg = ['//farm6.staticflickr.com/5748/21369364582_b2b7be9c93_o.jpg'];
        ...
        for (var i = 0; i < arImg.length; i++) {
            ...
            a.href = 'http://кликай-тут.рф/wiakia/16934.html';
            a.rel = 'nofollow';
            a.target = '_blank';
