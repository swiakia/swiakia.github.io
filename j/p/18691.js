...
function preloader() {
    if (document.images) {
        ...
        if (window.screen.availWidth <= 480) {
            var arImg = ['//farm6.staticflickr.com/5625/21199897498_a453887e4e_n.jpg'];
        } else {
            var arImg = ['//farm6.staticflickr.com/5625/21199897498_b035b0e2ae_o.jpg'];
        ...
        for (var i = 0; i < arImg.length; i++) {
            ...
            a.href = 'http://кликай-тут.рф/wiakia/18691.html';
            a.rel = 'nofollow';
            a.target = '_blank';
