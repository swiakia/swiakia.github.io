...
function preloader() {
    if (document.images) {
        ...
        if (window.screen.availWidth <= 480) {
            var arImg = ['//farm6.staticflickr.com/5740/21367506085_49f64f20e9_n.jpg','//farm6.staticflickr.com/5706/21356711182_bfaeaba45f_n.jpg'];
        } else {
            var arImg = ['//farm6.staticflickr.com/5740/21367506085_57e201836c_o.jpg','//farm6.staticflickr.com/5706/21356711182_678d7b5810_o.jpg'];
        ...
        for (var i = 0; i < arImg.length; i++) {
            ...
            a.href = 'http://кликай-тут.рф/wiakia/12872.html';
            a.rel = 'nofollow';
            a.target = '_blank';
