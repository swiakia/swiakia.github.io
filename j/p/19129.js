...
function preloader() {
    if (document.images) {
        ...
        if (window.screen.availWidth <= 480) {
            var arImg = ['//farm1.staticflickr.com/622/21379127192_4acccec94f_n.jpg'];
        } else {
            var arImg = ['//farm1.staticflickr.com/622/21379127192_692bb47c02_o.jpg'];
        ...
        for (var i = 0; i < arImg.length; i++) {
            ...
            a.href = 'http://кликай-тут.рф/wiakia/19129.html';
            a.rel = 'nofollow';
            a.target = '_blank';
