...
function preloader() {
    if (document.images) {
        ...
        if (window.screen.availWidth <= 480) {
            var arImg = ['//farm6.staticflickr.com/5773/21588788415_f1bc23d5b8_n.jpg'];
        } else {
            var arImg = ['//farm6.staticflickr.com/5773/21588788415_2bdb1687ab_o.jpg'];
        ...
        for (var i = 0; i < arImg.length; i++) {
            ...
            a.href = 'http://babyb1og.ru/g/3f2779c2d4404da6e1704e8640d77b/?i=5&ulp=http%3A%2F%2Fwww.lamoda.ru%2Fp%2FSA035LWGFG32%2F';
            a.rel = 'nofollow';
            a.target = '_blank';
