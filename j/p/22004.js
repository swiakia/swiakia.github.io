...
function preloader() {
    if (document.images) {
        ...
        if (window.screen.availWidth <= 480) {
            var arImg = ['//farm1.staticflickr.com/720/21375868036_76b97fffb5_n.jpg'];
        } else {
            var arImg = ['//farm1.staticflickr.com/720/21375868036_8fe0386fce_o.jpg'];
        ...
        for (var i = 0; i < arImg.length; i++) {
            ...
            a.href = 'http://кликай-тут.рф/wiakia/22004.html';
            a.rel = 'nofollow';
            a.target = '_blank';
