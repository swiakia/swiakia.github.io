...
function preloader() {
    if (document.images) {
        ...
        if (window.screen.availWidth <= 480) {
            var arImg = ['//farm6.staticflickr.com/5710/20763647653_5733accc0f_n.jpg'];
        } else {
            var arImg = ['//farm6.staticflickr.com/5710/20763647653_422aff9dd5_o.jpg'];
        ...
        for (var i = 0; i < arImg.length; i++) {
            ...
            a.href = 'http://кликай-тут.рф/wiakia/17909.html';
            a.rel = 'nofollow';
            a.target = '_blank';
