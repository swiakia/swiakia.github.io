...
function preloader() {
    if (document.images) {
        ...
        if (window.screen.availWidth <= 480) {
            var arImg = ['//farm6.staticflickr.com/5733/21400495461_bc87eef753_n.jpg'];
        } else {
            var arImg = ['//farm6.staticflickr.com/5733/21400495461_56b27228eb_o.jpg'];
        ...
        for (var i = 0; i < arImg.length; i++) {
            ...
            a.href = 'http://кликай-тут.рф/wiakia/19820.html';
            a.rel = 'nofollow';
            a.target = '_blank';
