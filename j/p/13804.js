...
function preloader() {
    if (document.images) {
        ...
        if (window.screen.availWidth <= 480) {
            var arImg = ['//farm1.staticflickr.com/669/21377606061_867c3e2850_n.jpg'];
        } else {
            var arImg = ['//farm1.staticflickr.com/669/21377606061_88c4bbff0d_o.jpg'];
        ...
        for (var i = 0; i < arImg.length; i++) {
            ...
            a.href = 'http://кликай-тут.рф/wiakia/13804.html';
            a.rel = 'nofollow';
            a.target = '_blank';
