...
function preloader() {
    if (document.images) {
        ...
        if (window.screen.availWidth <= 480) {
            var arImg = ['//farm1.staticflickr.com/781/21360863406_3444962098_n.jpg'];
        } else {
            var arImg = ['//farm1.staticflickr.com/781/21360863406_21e54660d6_o.jpg'];
        ...
        for (var i = 0; i < arImg.length; i++) {
            ...
            a.href = 'http://кликай-тут.рф/wiakia/18394.html';
            a.rel = 'nofollow';
            a.target = '_blank';
