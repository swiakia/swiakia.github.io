...
function preloader() {
    if (document.images) {
        ...
        if (window.screen.availWidth <= 480) {
            var arImg = ['//farm6.staticflickr.com/5797/20757939803_0374590185_n.jpg'];
        } else {
            var arImg = ['//farm6.staticflickr.com/5797/20757939803_9f47cd1066_o.jpg'];
        ...
        for (var i = 0; i < arImg.length; i++) {
            ...
            a.href = 'http://кликай-тут.рф/wiakia/16515.html';
            a.rel = 'nofollow';
            a.target = '_blank';
