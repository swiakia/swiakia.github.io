...
function preloader() {
    if (document.images) {
        ...
        if (window.screen.availWidth <= 480) {
            var arImg = ['//farm1.staticflickr.com/709/21196595850_f7338ccac6_n.jpg'];
        } else {
            var arImg = ['//farm1.staticflickr.com/709/21196595850_31c1c3a00a_o.jpg'];
        ...
        for (var i = 0; i < arImg.length; i++) {
            ...
            a.href = 'http://кликай-тут.рф/wiakia/17893.html';
            a.rel = 'nofollow';
            a.target = '_blank';
