...
function preloader() {
    if (document.images) {
        ...
        if (window.screen.availWidth <= 480) {
            var arImg = ['//farm6.staticflickr.com/5822/21378082001_d70a1f4142_n.jpg'];
        } else {
            var arImg = ['//farm6.staticflickr.com/5822/21378082001_7954e6a9c5_o.jpg'];
        ...
        for (var i = 0; i < arImg.length; i++) {
            ...
            a.href = 'http://кликай-тут.рф/wiakia/13740.html';
            a.rel = 'nofollow';
            a.target = '_blank';
