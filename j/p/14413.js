...
function preloader() {
    if (document.images) {
        ...
        if (window.screen.availWidth <= 480) {
            var arImg = ['//farm6.staticflickr.com/5775/21184839619_bc40d6607b_n.jpg','//farm6.staticflickr.com/5743/21345493076_ff8acb43b7_n.jpg'];
        } else {
            var arImg = ['//farm6.staticflickr.com/5775/21184839619_e0c3901188_o.jpg','//farm6.staticflickr.com/5743/21345493076_ece4338c6e_o.jpg'];
        ...
        for (var i = 0; i < arImg.length; i++) {
            ...
            a.href = 'http://кликай-тут.рф/wiakia/14413.html';
            a.rel = 'nofollow';
            a.target = '_blank';
