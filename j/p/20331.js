...
function preloader() {
    if (document.images) {
        ...
        if (window.screen.availWidth <= 480) {
            var arImg = ['//farm1.staticflickr.com/781/21402213821_d5a75d97c5_n.jpg'];
        } else {
            var arImg = ['//farm1.staticflickr.com/781/21402213821_e459f8705f_o.jpg'];
        ...
        for (var i = 0; i < arImg.length; i++) {
            ...
            a.href = 'http://кликай-тут.рф/wiakia/20331.html';
            a.rel = 'nofollow';
            a.target = '_blank';
