...
function preloader() {
    if (document.images) {
        ...
        if (window.screen.availWidth <= 480) {
            var arImg = ['//farm1.staticflickr.com/683/20759314193_8916149389_n.jpg'];
        } else {
            var arImg = ['//farm1.staticflickr.com/683/20759314193_fddc6e1297_o.jpg'];
        ...
        for (var i = 0; i < arImg.length; i++) {
            ...
            a.href = 'http://кликай-тут.рф/wiakia/16947.html';
            a.rel = 'nofollow';
            a.target = '_blank';
