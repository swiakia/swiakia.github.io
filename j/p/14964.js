...
function preloader() {
    if (document.images) {
        ...
        if (window.screen.availWidth <= 480) {
            var arImg = ['//farm6.staticflickr.com/5619/21186842969_bbfc9fedaf_n.jpg','//farm1.staticflickr.com/752/21382067481_e2f9178380_n.jpg'];
        } else {
            var arImg = ['//farm6.staticflickr.com/5619/21186842969_753b2258a4_o.jpg','//farm1.staticflickr.com/752/21382067481_aac26ce037_o.jpg'];
        ...
        for (var i = 0; i < arImg.length; i++) {
            ...
            a.href = 'http://кликай-тут.рф/wiakia/14964.html';
            a.rel = 'nofollow';
            a.target = '_blank';
