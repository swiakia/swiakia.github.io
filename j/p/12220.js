...
function preloader() {
    if (document.images) {
        ...
        if (window.screen.availWidth <= 480) {
            var arImg = ['//farm6.staticflickr.com/5781/21341220586_7358463c65_n.jpg'];
        } else {
            var arImg = ['//farm6.staticflickr.com/5781/21341220586_7441aa99b3_o.jpg'];
        ...
        for (var i = 0; i < arImg.length; i++) {
            ...
            a.href = 'http://кликай-тут.рф/wiakia/12220.html';
            a.rel = 'nofollow';
            a.target = '_blank';
...
function preCouImg() {
    ...
    var cImg = ['<img class="ic" alt="Израиль" src="'+il+'" /><span class="instok">Израиль</span>',];
