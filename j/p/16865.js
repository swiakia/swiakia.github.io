...
function preloader() {
    if (document.images) {
        ...
        if (window.screen.availWidth <= 480) {
            var arImg = ['//farm1.staticflickr.com/718/21191869490_6e5aeb7c02_n.jpg'];
        } else {
            var arImg = ['//farm1.staticflickr.com/718/21191869490_4bdd6d8dcf_o.jpg'];
        ...
        for (var i = 0; i < arImg.length; i++) {
            ...
            a.href = 'http://кликай-тут.рф/wiakia/16865.html';
            a.rel = 'nofollow';
            a.target = '_blank';
