...
function preloader() {
    if (document.images) {
        ...
        if (window.screen.availWidth <= 480) {
            var arImg = ['//farm6.staticflickr.com/5764/21353719346_87d5eb83da_n.jpg'];
        } else {
            var arImg = ['//farm6.staticflickr.com/5764/21353719346_2eeda6be9d_o.jpg'];
        ...
        for (var i = 0; i < arImg.length; i++) {
            ...
            a.href = 'http://кликай-тут.рф/wiakia/16864.html';
            a.rel = 'nofollow';
            a.target = '_blank';
