...
function preloader() {
    if (document.images) {
        ...
        if (window.screen.availWidth <= 480) {
            var arImg = ['//farm1.staticflickr.com/749/21345379866_155f4e4330_n.jpg'];
        } else {
            var arImg = ['//farm1.staticflickr.com/749/21345379866_e29b354829_o.jpg'];
        ...
        for (var i = 0; i < arImg.length; i++) {
            ...
            a.href = 'http://кликай-тут.рф/wiakia/14371.html';
            a.rel = 'nofollow';
            a.target = '_blank';
