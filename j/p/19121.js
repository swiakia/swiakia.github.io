...
function preloader() {
    if (document.images) {
        ...
        if (window.screen.availWidth <= 480) {
            var arImg = ['//farm1.staticflickr.com/746/21203022869_304350d9a5_n.jpg'];
        } else {
            var arImg = ['//farm1.staticflickr.com/746/21203022869_1b3719ae1d_o.jpg'];
        ...
        for (var i = 0; i < arImg.length; i++) {
            ...
            a.href = 'http://кликай-тут.рф/wiakia/19121.html';
            a.rel = 'nofollow';
            a.target = '_blank';
