...
function preloader() {
    if (document.images) {
        ...
        if (window.screen.availWidth <= 480) {
            var arImg = ['//farm1.staticflickr.com/625/21191963760_cc4100e588_n.jpg'];
        } else {
            var arImg = ['//farm1.staticflickr.com/625/21191963760_11688dfac3_o.jpg'];
        ...
        for (var i = 0; i < arImg.length; i++) {
            ...
            a.href = 'http://кликай-тут.рф/wiakia/16893.html';
            a.rel = 'nofollow';
            a.target = '_blank';
