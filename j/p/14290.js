...
function preloader() {
    if (document.images) {
        ...
        if (window.screen.availWidth <= 480) {
            var arImg = ['//farm6.staticflickr.com/5652/21359675212_2f1e0d5dab_n.jpg'];
        } else {
            var arImg = ['//farm6.staticflickr.com/5652/21359675212_920d4d9ae9_o.jpg'];
        ...
        for (var i = 0; i < arImg.length; i++) {
            ...
            a.href = 'http://кликай-тут.рф/wiakia/14290.html';
            a.rel = 'nofollow';
            a.target = '_blank';
