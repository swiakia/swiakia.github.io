...
function preloader() {
    if (document.images) {
        ...
        if (window.screen.availWidth <= 480) {
            var arImg = ['//farm6.staticflickr.com/5626/21391131372_a6a5bc11e6_n.jpg','//farm6.staticflickr.com/5791/20779289074_d1020437d6_n.jpg'];
        } else {
            var arImg = ['//farm6.staticflickr.com/5626/21391131372_fe4242ee87_o.jpg','//farm6.staticflickr.com/5791/20779289074_723f35f9ea_o.jpg'];
        ...
        for (var i = 0; i < arImg.length; i++) {
            ...
            a.href = 'http://кликай-тут.рф/wiakia/21991.html';
            a.rel = 'nofollow';
            a.target = '_blank';
