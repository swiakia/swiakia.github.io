...
function preloader() {
    if (document.images) {
        ...
        if (window.screen.availWidth <= 480) {
            var arImg = ['//farm6.staticflickr.com/5780/21192959009_c61b77d8d0_n.jpg'];
        } else {
            var arImg = ['//farm6.staticflickr.com/5780/21192959009_2131062dea_o.jpg'];
        ...
        for (var i = 0; i < arImg.length; i++) {
            ...
            a.href = 'http://кликай-тут.рф/wiakia/16813.html';
            a.rel = 'nofollow';
            a.target = '_blank';
