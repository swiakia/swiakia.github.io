...
function preloader() {
    if (document.images) {
        ...
        if (window.screen.availWidth <= 480) {
            var arImg = ['//farm1.staticflickr.com/774/21020809023_754c529efd_n.jpg'];
        } else {
            var arImg = ['//farm1.staticflickr.com/774/21020809023_9d78935fd8_o.jpg'];
        ...
        for (var i = 0; i < arImg.length; i++) {
            ...
            a.href = 'http://babyb1og.ru/g/3f2779c2d4404da6e1704e8640d77b/?i=5&ulp=http%3A%2F%2Fwww.lamoda.ru%2Fp%2FNA007DWGLA50%2F';
            a.rel = 'nofollow';
            a.target = '_blank';
