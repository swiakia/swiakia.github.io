...
function preloader() {
    if (document.images) {
        ...
        if (window.screen.availWidth <= 480) {
            var arImg = ['//farm1.staticflickr.com/692/21358043786_ab81f73c68_n.jpg'];
        } else {
            var arImg = ['//farm1.staticflickr.com/692/21358043786_108d6df557_o.jpg'];
        ...
        for (var i = 0; i < arImg.length; i++) {
            ...
            a.href = 'http://кликай-тут.рф/wiakia/17780.html';
            a.rel = 'nofollow';
            a.target = '_blank';
