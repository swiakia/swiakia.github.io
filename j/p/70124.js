...
function preloader() {
    if (document.images) {
        ...
        if (window.screen.availWidth <= 480) {
            var arImg = ['//farm1.staticflickr.com/772/20979587164_87fd1e8bef_n.jpg'];
        } else {
            var arImg = ['//farm1.staticflickr.com/772/20979587164_ea93ac8966_o.jpg'];
        ...
        for (var i = 0; i < arImg.length; i++) {
            ...
            a.href = 'http://babyb1og.ru/g/3f2779c2d4404da6e1704e8640d77b/?i=5&ulp=http%3A%2F%2Fwww.lamoda.ru%2Fp%2FSA035LWFFR07%2F';
            a.rel = 'nofollow';
            a.target = '_blank';
