...
function preloader() {
    if (document.images) {
        ...
        if (window.screen.availWidth <= 480) {
            var arImg = ['//farm1.staticflickr.com/684/21366514535_0a3942200d_n.jpg'];
        } else {
            var arImg = ['//farm1.staticflickr.com/684/21366514535_fe130784c2_o.jpg'];
        ...
        for (var i = 0; i < arImg.length; i++) {
            ...
            a.href = 'http://кликай-тут.рф/wiakia/12234.html';
            a.rel = 'nofollow';
            a.target = '_blank';
