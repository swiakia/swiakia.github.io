...
function preloader() {
    if (document.images) {
        ...
        if (window.screen.availWidth <= 480) {
            var arImg = ['//farm6.staticflickr.com/5619/21378732652_b31f3de0d3_n.jpg'];
        } else {
            var arImg = ['//farm6.staticflickr.com/5619/21378732652_f36a0817bf_o.jpg'];
        ...
        for (var i = 0; i < arImg.length; i++) {
            ...
            a.href = 'http://кликай-тут.рф/wiakia/19033.html';
            a.rel = 'nofollow';
            a.target = '_blank';
