...
function preloader() {
    if (document.images) {
        ...
        if (window.screen.availWidth <= 480) {
            var arImg = ['//farm6.staticflickr.com/5643/21379988735_3170137d50_n.jpg'];
        } else {
            var arImg = ['//farm6.staticflickr.com/5643/21379988735_75febfa47f_o.jpg'];
        ...
        for (var i = 0; i < arImg.length; i++) {
            ...
            a.href = 'http://кликай-тут.рф/wiakia/16868.html';
            a.rel = 'nofollow';
            a.target = '_blank';
