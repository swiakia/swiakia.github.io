...
function preloader() {
    if (document.images) {
        ...
        if (window.screen.availWidth <= 480) {
            var arImg = ['//farm1.staticflickr.com/628/21400521191_30a6e378e4_n.jpg'];
        } else {
            var arImg = ['//farm1.staticflickr.com/628/21400521191_d7289ddaf1_o.jpg'];
        ...
        for (var i = 0; i < arImg.length; i++) {
            ...
            a.href = 'http://кликай-тут.рф/wiakia/19857.html';
            a.rel = 'nofollow';
            a.target = '_blank';
