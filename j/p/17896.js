...
function preloader() {
    if (document.images) {
        ...
        if (window.screen.availWidth <= 480) {
            var arImg = ['//farm1.staticflickr.com/779/21393047311_b816a0d460_n.jpg'];
        } else {
            var arImg = ['//farm1.staticflickr.com/779/21393047311_826754676a_o.jpg'];
        ...
        for (var i = 0; i < arImg.length; i++) {
            ...
            a.href = 'http://кликай-тут.рф/wiakia/17896.html';
            a.rel = 'nofollow';
            a.target = '_blank';
