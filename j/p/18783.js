...
function preloader() {
    if (document.images) {
        ...
        if (window.screen.availWidth <= 480) {
            var arImg = ['//farm6.staticflickr.com/5664/21396663601_e498db586d_n.jpg'];
        } else {
            var arImg = ['//farm6.staticflickr.com/5664/21396663601_0eae13ed04_o.jpg'];
        ...
        for (var i = 0; i < arImg.length; i++) {
            ...
            a.href = 'http://кликай-тут.рф/wiakia/18783.html';
            a.rel = 'nofollow';
            a.target = '_blank';
