...
function preloader() {
    if (document.images) {
        ...
        if (window.screen.availWidth <= 480) {
            var arImg = ['//farm6.staticflickr.com/5746/20747980024_fe8996c539_n.jpg'];
        } else {
            var arImg = ['//farm6.staticflickr.com/5746/20747980024_4742fd2de3_o.jpg'];
        ...
        for (var i = 0; i < arImg.length; i++) {
            ...
            a.href = 'http://кликай-тут.рф/wiakia/14293.html';
            a.rel = 'nofollow';
            a.target = '_blank';
