...
function preloader() {
    if (document.images) {
        ...
        if (window.screen.availWidth <= 480) {
            var arImg = ['//farm6.staticflickr.com/5712/21368334272_5916d812fd_n.jpg'];
        } else {
            var arImg = ['//farm6.staticflickr.com/5712/21368334272_697739a3fe_o.jpg'];
        ...
        for (var i = 0; i < arImg.length; i++) {
            ...
            a.href = 'http://кликай-тут.рф/wiakia/16582.html';
            a.rel = 'nofollow';
            a.target = '_blank';
