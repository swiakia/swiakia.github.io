...
function preloader() {
    if (document.images) {
        ...
        if (window.screen.availWidth <= 480) {
            var arImg = ['//farm1.staticflickr.com/571/21369259762_a2cf8f9dc2_n.jpg'];
        } else {
            var arImg = ['//farm1.staticflickr.com/571/21369259762_c474060c90_o.jpg'];
        ...
        for (var i = 0; i < arImg.length; i++) {
            ...
            a.href = 'http://кликай-тут.рф/wiakia/16894.html';
            a.rel = 'nofollow';
            a.target = '_blank';
