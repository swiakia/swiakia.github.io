...
function preloader() {
    if (document.images) {
        ...
        if (window.screen.availWidth <= 480) {
            var arImg = ['//farm6.staticflickr.com/5773/21193277779_df50218dc3_n.jpg'];
        } else {
            var arImg = ['//farm6.staticflickr.com/5773/21193277779_0f8fd74b28_o.jpg'];
        ...
        for (var i = 0; i < arImg.length; i++) {
            ...
            a.href = 'http://кликай-тут.рф/wiakia/16935.html';
            a.rel = 'nofollow';
            a.target = '_blank';
