...
function preloader() {
    if (document.images) {
        ...
        if (window.screen.availWidth <= 480) {
            var arImg = ['//farm6.staticflickr.com/5750/21215930030_faaed0a1d2_n.jpg'];
        } else {
            var arImg = ['//farm6.staticflickr.com/5750/21215930030_514d330a0d_o.jpg'];
        ...
        for (var i = 0; i < arImg.length; i++) {
            ...
            a.href = 'http://кликай-тут.рф/wiakia/22422.html';
            a.rel = 'nofollow';
            a.target = '_blank';
