...
function preloader() {
    if (document.images) {
        ...
        if (window.screen.availWidth <= 480) {
            var arImg = ['//farm6.staticflickr.com/5618/21202214438_7b4b19fc11_n.jpg'];
        } else {
            var arImg = ['//farm6.staticflickr.com/5618/21202214438_28c60fe324_o.jpg'];
        ...
        for (var i = 0; i < arImg.length; i++) {
            ...
            a.href = 'http://кликай-тут.рф/wiakia/19149.html';
            a.rel = 'nofollow';
            a.target = '_blank';
