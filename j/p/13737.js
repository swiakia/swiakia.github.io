...
function preloader() {
    if (document.images) {
        ...
        if (window.screen.availWidth <= 480) {
            var arImg = ['//farm6.staticflickr.com/5666/20748603693_5a3e731473_n.jpg'];
        } else {
            var arImg = ['//farm6.staticflickr.com/5666/20748603693_bb55fc89fe_o.jpg'];
        ...
        for (var i = 0; i < arImg.length; i++) {
            ...
            a.href = 'http://кликай-тут.рф/wiakia/13737.html';
            a.rel = 'nofollow';
            a.target = '_blank';
