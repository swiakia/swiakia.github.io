...
function preloader() {
    if (document.images) {
        ...
        if (window.screen.availWidth <= 480) {
            var arImg = ['//farm1.staticflickr.com/585/21344234496_2a285256bd_n.jpg'];
        } else {
            var arImg = ['//farm1.staticflickr.com/585/21344234496_f66f790dd5_o.jpg'];
        ...
        for (var i = 0; i < arImg.length; i++) {
            ...
            a.href = 'http://кликай-тут.рф/wiakia/14291.html';
            a.rel = 'nofollow';
            a.target = '_blank';
