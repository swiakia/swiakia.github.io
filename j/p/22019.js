...
function preloader() {
    if (document.images) {
        ...
        if (window.screen.availWidth <= 480) {
            var arImg = ['//farm1.staticflickr.com/641/21215235059_ddf4fd6aa7_n.jpg'];
        } else {
            var arImg = ['//farm1.staticflickr.com/641/21215235059_0179c8ab27_o.jpg'];
        ...
        for (var i = 0; i < arImg.length; i++) {
            ...
            a.href = 'http://кликай-тут.рф/wiakia/22019.html';
            a.rel = 'nofollow';
            a.target = '_blank';
