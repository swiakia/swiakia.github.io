...
function preloader() {
    if (document.images) {
        ...
        if (window.screen.availWidth <= 480) {
            var arImg = ['//farm6.staticflickr.com/5751/21345317216_057e3cf17e_n.jpg'];
        } else {
            var arImg = ['//farm6.staticflickr.com/5751/21345317216_a1dd39017a_o.jpg'];
        ...
        for (var i = 0; i < arImg.length; i++) {
            ...
            a.href = 'http://кликай-тут.рф/wiakia/14304.html';
            a.rel = 'nofollow';
            a.target = '_blank';
