...
function preloader() {
    if (document.images) {
        ...
        if (window.screen.availWidth <= 480) {
            var arImg = ['//farm6.staticflickr.com/5797/21377097311_550b00c0ff_n.jpg'];
        } else {
            var arImg = ['//farm6.staticflickr.com/5797/21377097311_41679f4f62_o.jpg'];
        ...
        for (var i = 0; i < arImg.length; i++) {
            ...
            a.href = 'http://кликай-тут.рф/wiakia/13758.html';
            a.rel = 'nofollow';
            a.target = '_blank';
