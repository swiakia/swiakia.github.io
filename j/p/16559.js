...
function preloader() {
    if (document.images) {
        ...
        if (window.screen.availWidth <= 480) {
            var arImg = ['//farm6.staticflickr.com/5632/20756420804_64e6962dff_n.jpg'];
        } else {
            var arImg = ['//farm6.staticflickr.com/5632/20756420804_ef681ebe16_o.jpg'];
        ...
        for (var i = 0; i < arImg.length; i++) {
            ...
            a.href = 'http://кликай-тут.рф/wiakia/16559.html';
            a.rel = 'nofollow';
            a.target = '_blank';
