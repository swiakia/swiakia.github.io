...
function preloader() {
    if (document.images) {
        ...
        if (window.screen.availWidth <= 480) {
            var arImg = ['//farm6.staticflickr.com/5656/21373723865_d89502478b_n.jpg','//farm6.staticflickr.com/5621/20752626313_8c6d970caf_n.jpg'];
        } else {
            var arImg = ['//farm6.staticflickr.com/5656/21373723865_2761b4d5a4_o.jpg','//farm6.staticflickr.com/5621/20752626313_411f287d20_o.jpg'];
        ...
        for (var i = 0; i < arImg.length; i++) {
            ...
            a.href = 'http://кликай-тут.рф/wiakia/14923.html';
            a.rel = 'nofollow';
            a.target = '_blank';
