...
function preloader() {
    if (document.images) {
        ...
        if (window.screen.availWidth <= 480) {
            var arImg = ['//farm6.staticflickr.com/5648/21351111046_bfab8190a6_n.jpg','//farm6.staticflickr.com/5670/20754678574_ae0c73b1d5_n.jpg'];
        } else {
            var arImg = ['//farm6.staticflickr.com/5648/21351111046_25b6b86732_o.jpg','//farm6.staticflickr.com/5670/20754678574_9606cd56b0_o.jpg'];
        ...
        for (var i = 0; i < arImg.length; i++) {
            ...
            a.href = 'http://кликай-тут.рф/wiakia/15907.html';
            a.rel = 'nofollow';
            a.target = '_blank';
