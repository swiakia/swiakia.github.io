...
function preloader() {
    if (document.images) {
        ...
        if (window.screen.availWidth <= 480) {
            var arImg = ['//farm6.staticflickr.com/5762/21181898068_957efe5182_n.jpg'];
        } else {
            var arImg = ['//farm6.staticflickr.com/5762/21181898068_a0c2018e11_o.jpg'];
        ...
        for (var i = 0; i < arImg.length; i++) {
            ...
            a.href = 'http://кликай-тут.рф/wiakia/13739.html';
            a.rel = 'nofollow';
            a.target = '_blank';
