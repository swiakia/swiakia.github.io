...
function preloader() {
    if (document.images) {
        ...
        if (window.screen.availWidth <= 480) {
            var arImg = ['//farm6.staticflickr.com/5811/20743848234_39236b4dfb_n.jpg'];
        } else {
            var arImg = ['//farm6.staticflickr.com/5811/20743848234_f622846568_o.jpg'];
        ...
        for (var i = 0; i < arImg.length; i++) {
            ...
            a.href = 'http://кликай-тут.рф/wiakia/12236.html';
            a.rel = 'nofollow';
            a.target = '_blank';
