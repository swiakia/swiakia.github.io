...
function preloader() {
    if (document.images) {
        ...
        if (window.screen.availWidth <= 480) {
            var arImg = ['//farm6.staticflickr.com/5638/21185379630_b5e6b35138_n.jpg'];
        } else {
            var arImg = ['//farm6.staticflickr.com/5638/21185379630_bb062eb707_o.jpg'];
        ...
        for (var i = 0; i < arImg.length; i++) {
            ...
            a.href = 'http://кликай-тут.рф/wiakia/14838.html';
            a.rel = 'nofollow';
            a.target = '_blank';
