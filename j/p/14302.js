...
function preloader() {
    if (document.images) {
        ...
        if (window.screen.availWidth <= 480) {
            var arImg = ['//farm6.staticflickr.com/5759/21183702288_879db31b27_n.jpg'];
        } else {
            var arImg = ['//farm6.staticflickr.com/5759/21183702288_207ba78b8f_o.jpg'];
        ...
        for (var i = 0; i < arImg.length; i++) {
            ...
            a.href = 'http://кликай-тут.рф/wiakia/14302.html';
            a.rel = 'nofollow';
            a.target = '_blank';
