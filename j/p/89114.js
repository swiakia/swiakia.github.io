...
function preloader() {
    if (document.images) {
        ...
        if (window.screen.availWidth <= 480) {
            var arImg = ['//farm6.staticflickr.com/5690/21800357341_0ffabcba92_n.jpg'];
        } else {
            var arImg = ['//farm6.staticflickr.com/5690/21800357341_2e03076b06_o.jpg'];
        ...
        for (var i = 0; i < arImg.length; i++) {
            ...
            a.href = 'http://babyb1og.ru/g/3f2779c2d4404da6e1704e8640d77b/?i=5&ulp=http%3A%2F%2Fwww.lamoda.ru%2Fp%2FSE028LWGNA61%2F';
            a.rel = 'nofollow';
            a.target = '_blank';
