...
function preloader() {
    if (document.images) {
        ...
        if (window.screen.availWidth <= 480) {
            var arImg = ['//farm1.staticflickr.com/586/21181393699_8bce2cb756_n.jpg','//farm6.staticflickr.com/5734/21357505972_c6b8433bba_n.jpg','//farm6.staticflickr.com/5767/21342037736_a79db1b6a9_n.jpg','//farm1.staticflickr.com/631/20745588394_ecf2621a2e_n.jpg'];
        } else {
            var arImg = ['//farm1.staticflickr.com/586/21181393699_f2ee2f09a5_o.jpg','//farm6.staticflickr.com/5734/21357505972_f1f7a31bd7_o.jpg','//farm6.staticflickr.com/5767/21342037736_62791d2170_o.jpg','//farm1.staticflickr.com/631/20745588394_d2b6a1d435_o.jpg'];
        ...
        for (var i = 0; i < arImg.length; i++) {
            ...
            a.href = 'http://кликай-тут.рф/wiakia/13204.html';
            a.rel = 'nofollow';
            a.target = '_blank';
...
function preCouImg() {
    var id = 'data:image/svg+xml;base64,PHN2ZyB4bWxucz0iaHR0cDovL3d3dy53My5vcmcvMjAwMC9zdmciIHZpZXdCb3g9IjAgMCA2MDAgNDAwIj4NCjxwYXRoIGZpbGw9IiNjZTExMjYiIGQ9Im0wLDBoNjAwdjIwMGgtNjAweiIvPg0KPHBhdGggZmlsbD0iI2ZmZiIgZD0ibTAsMjAwaDYwMHYyMDBoLTYwMHoiLz4NCjwvc3ZnPg0K';
    var cImg = ['<img class="ic" alt="Индонезия" src="'+id+'" /><span class="instok">Индонезия</span>',];
