...
function preloader() {
    if (document.images) {
        ...
        if (window.screen.availWidth <= 480) {
            var arImg = ['//farm1.staticflickr.com/759/21379166585_1155faf0d8_n.jpg'];
        } else {
            var arImg = ['//farm1.staticflickr.com/759/21379166585_854334a7c0_o.jpg'];
        ...
        for (var i = 0; i < arImg.length; i++) {
            ...
            a.href = 'http://кликай-тут.рф/wiakia/16590.html';
            a.rel = 'nofollow';
            a.target = '_blank';
