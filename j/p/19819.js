...
function preloader() {
    if (document.images) {
        ...
        if (window.screen.availWidth <= 480) {
            var arImg = ['//farm1.staticflickr.com/736/21205209909_b12cf6ea28_n.jpg'];
        } else {
            var arImg = ['//farm1.staticflickr.com/736/21205209909_07cf2a92f9_o.jpg'];
        ...
        for (var i = 0; i < arImg.length; i++) {
            ...
            a.href = 'http://кликай-тут.рф/wiakia/19819.html';
            a.rel = 'nofollow';
            a.target = '_blank';
