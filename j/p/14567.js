...
function preloader() {
    if (document.images) {
        ...
        if (window.screen.availWidth <= 480) {
            var arImg = ['//farm6.staticflickr.com/5637/21361582202_40c69f5b5a_n.jpg','//farm6.staticflickr.com/5764/20751277513_316a7729f8_n.jpg'];
        } else {
            var arImg = ['//farm6.staticflickr.com/5637/21361582202_f0c9f54931_o.jpg','//farm6.staticflickr.com/5764/20751277513_8a0db53deb_o.jpg'];
        ...
        for (var i = 0; i < arImg.length; i++) {
            ...
            a.href = 'http://кликай-тут.рф/wiakia/14567.html';
            a.rel = 'nofollow';
            a.target = '_blank';
