...
function preloader() {
    if (document.images) {
        ...
        if (window.screen.availWidth <= 480) {
            var arImg = ['//farm1.staticflickr.com/648/21388191971_41653c79a8_n.jpg'];
        } else {
            var arImg = ['//farm1.staticflickr.com/648/21388191971_48e5cc210a_o.jpg'];
        ...
        for (var i = 0; i < arImg.length; i++) {
            ...
            a.href = 'http://кликай-тут.рф/wiakia/16808.html';
            a.rel = 'nofollow';
            a.target = '_blank';
