...
function preloader() {
    if (document.images) {
        ...
        if (window.screen.availWidth <= 480) {
            var arImg = ['//farm1.staticflickr.com/677/21377077071_4a3cb2afd8_n.jpg'];
        } else {
            var arImg = ['//farm1.staticflickr.com/677/21377077071_d0524373f0_o.jpg'];
        ...
        for (var i = 0; i < arImg.length; i++) {
            ...
            a.href = 'http://кликай-тут.рф/wiakia/13757.html';
            a.rel = 'nofollow';
            a.target = '_blank';
