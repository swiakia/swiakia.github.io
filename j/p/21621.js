...
function preloader() {
    if (document.images) {
        ...
        if (window.screen.availWidth <= 480) {
            var arImg = ['//farm6.staticflickr.com/5671/21373775386_ea2a2d8fbc_n.jpg','//farm6.staticflickr.com/5756/21212172718_4459be4c39_n.jpg'];
        } else {
            var arImg = ['//farm6.staticflickr.com/5671/21373775386_02ab140303_o.jpg','//farm6.staticflickr.com/5756/21212172718_67c5acbcab_o.jpg'];
        ...
        for (var i = 0; i < arImg.length; i++) {
            ...
            a.href = 'http://кликай-тут.рф/wiakia/21621.html';
            a.rel = 'nofollow';
            a.target = '_blank';
