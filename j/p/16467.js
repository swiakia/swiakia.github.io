...
function preloader() {
    if (document.images) {
        ...
        if (window.screen.availWidth <= 480) {
            var arImg = ['//farm6.staticflickr.com/5639/21191028758_cf7e37575e_n.jpg'];
        } else {
            var arImg = ['//farm6.staticflickr.com/5639/21191028758_171d342a5a_o.jpg'];
        ...
        for (var i = 0; i < arImg.length; i++) {
            ...
            a.href = 'http://кликай-тут.рф/wiakia/16467.html';
            a.rel = 'nofollow';
            a.target = '_blank';
