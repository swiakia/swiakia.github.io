...
function preloader() {
    if (document.images) {
        ...
        if (window.screen.availWidth <= 480) {
            var arImg = ['//farm6.staticflickr.com/5619/21410258961_29400df5ac_n.jpg'];
        } else {
            var arImg = ['//farm6.staticflickr.com/5619/21410258961_72c7a216c6_o.jpg'];
        ...
        for (var i = 0; i < arImg.length; i++) {
            ...
            a.href = 'http://кликай-тут.рф/wiakia/21960.html';
            a.rel = 'nofollow';
            a.target = '_blank';
