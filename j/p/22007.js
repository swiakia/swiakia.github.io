...
function preloader() {
    if (document.images) {
        ...
        if (window.screen.availWidth <= 480) {
            var arImg = ['//farm6.staticflickr.com/5735/21214260588_34ce5a6493_n.jpg'];
        } else {
            var arImg = ['//farm6.staticflickr.com/5735/21214260588_3576be88ba_o.jpg'];
        ...
        for (var i = 0; i < arImg.length; i++) {
            ...
            a.href = 'http://кликай-тут.рф/wiakia/22007.html';
            a.rel = 'nofollow';
            a.target = '_blank';
