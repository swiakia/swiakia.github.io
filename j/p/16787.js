...
function preloader() {
    if (document.images) {
        ...
        if (window.screen.availWidth <= 480) {
            var arImg = ['//farm6.staticflickr.com/5730/21191732060_39088a3b47_n.jpg','//farm6.staticflickr.com/5640/20758759363_0383aafef4_n.jpg'];
        } else {
            var arImg = ['//farm6.staticflickr.com/5730/21191732060_d13f2f0cdf_o.jpg','//farm6.staticflickr.com/5640/20758759363_ab611d7d10_o.jpg'];
        ...
        for (var i = 0; i < arImg.length; i++) {
            ...
            a.href = 'http://кликай-тут.рф/wiakia/16787.html';
            a.rel = 'nofollow';
            a.target = '_blank';
