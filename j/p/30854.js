...
function preloader() {
    if (document.images) {
        ...
        if (window.screen.availWidth <= 480) {
            var arImg = ['//farm1.staticflickr.com/628/21266328569_aed25bde35_n.jpg'];
        } else {
            var arImg = ['//farm1.staticflickr.com/628/21266328569_c072d73b4e_o.jpg'];
        ...
        for (var i = 0; i < arImg.length; i++) {
            ...
            a.href = 'http://babyb1og.ru/g/3f2779c2d4404da6e1704e8640d77b/?i=5&ulp=http%3A%2F%2Fwww.lamoda.ru%2Fp%2FLO006LWFQZ43%2F';
            a.rel = 'nofollow';
            a.target = '_blank';
