...
function preloader() {
    if (document.images) {
        ...
        if (window.screen.availWidth <= 480) {
            var arImg = ['//farm1.staticflickr.com/675/21030802374_8b2eb4bebc_n.jpg'];
        } else {
            var arImg = ['//farm1.staticflickr.com/675/21030802374_766ac5b1e0_o.jpg'];
        ...
        for (var i = 0; i < arImg.length; i++) {
            ...
            a.href = 'http://babyb1og.ru/g/3f2779c2d4404da6e1704e8640d77b/?i=5&ulp=http%3A%2F%2Fwww.lamoda.ru%2Fp%2FAN042LWGLC82%2F';
            a.rel = 'nofollow';
            a.target = '_blank';
