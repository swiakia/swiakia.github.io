...
function preloader() {
    if (document.images) {
        ...
        if (window.screen.availWidth <= 480) {
            var arImg = ['//farm6.staticflickr.com/5816/21356737422_1c59f9a5b8_n.jpg','//farm6.staticflickr.com/5683/21179653018_cf0da55218_n.jpg'];
        } else {
            var arImg = ['//farm6.staticflickr.com/5816/21356737422_74e1c3c35f_o.jpg','//farm6.staticflickr.com/5683/21179653018_be739cdecd_o.jpg'];
        ...
        for (var i = 0; i < arImg.length; i++) {
            ...
            a.href = 'http://кликай-тут.рф/wiakia/12883.html';
            a.rel = 'nofollow';
            a.target = '_blank';
...
function preCouImg() {
    ...
    var cImg = ['<img class="ic" alt="Германия" src="'+de+'" /><span class="instok">Германия</span>',];
