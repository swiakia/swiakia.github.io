...
function preloader() {
    if (document.images) {
        ...
        if (window.screen.availWidth <= 480) {
            var arImg = ['//farm1.staticflickr.com/662/21398447581_56209bddc5_n.jpg'];
        } else {
            var arImg = ['//farm1.staticflickr.com/662/21398447581_d5af64fdd7_o.jpg'];
        ...
        for (var i = 0; i < arImg.length; i++) {
            ...
            a.href = 'http://кликай-тут.рф/wiakia/19170.html';
            a.rel = 'nofollow';
            a.target = '_blank';
