...
function preloader() {
    if (document.images) {
        ...
        if (window.screen.availWidth <= 480) {
            var arImg = ['//farm1.staticflickr.com/748/21182087178_8874a01380_n.jpg'];
        } else {
            var arImg = ['//farm1.staticflickr.com/748/21182087178_b2fa786c3f_o.jpg'];
        ...
        for (var i = 0; i < arImg.length; i++) {
            ...
            a.href = 'http://кликай-тут.рф/wiakia/14060.html';
            a.rel = 'nofollow';
            a.target = '_blank';
