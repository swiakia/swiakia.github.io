...
function preloader() {
    if (document.images) {
        ...
        if (window.screen.availWidth <= 480) {
            var arImg = ['//farm1.staticflickr.com/730/21183680729_80631d60a2_n.jpg'];
        } else {
            var arImg = ['//farm1.staticflickr.com/730/21183680729_fd02e3d586_o.jpg'];
        ...
        for (var i = 0; i < arImg.length; i++) {
            ...
            a.href = 'http://кликай-тут.рф/wiakia/14292.html';
            a.rel = 'nofollow';
            a.target = '_blank';
