...
function preloader() {
    if (document.images) {
        ...
        if (window.screen.availWidth <= 480) {
            var arImg = ['//farm6.staticflickr.com/5746/21215949778_f08732e990_n.jpg'];
        } else {
            var arImg = ['//farm6.staticflickr.com/5746/21215949778_6f7d25e8ec_o.jpg'];
        ...
        for (var i = 0; i < arImg.length; i++) {
            ...
            a.href = 'http://кликай-тут.рф/wiakia/22386.html';
            a.rel = 'nofollow';
            a.target = '_blank';
