...
function preloader() {
    if (document.images) {
        ...
        if (window.screen.availWidth <= 480) {
            var arImg = ['//farm6.staticflickr.com/5792/21345569406_e7b854378e_n.jpg','//farm6.staticflickr.com/5760/20749135364_7495c4eb3e_n.jpg'];
        } else {
            var arImg = ['//farm6.staticflickr.com/5792/21345569406_c24894fddf_o.jpg','//farm6.staticflickr.com/5760/20749135364_c2f7cfa271_o.jpg'];
        ...
        for (var i = 0; i < arImg.length; i++) {
            ...
            a.href = 'http://кликай-тут.рф/wiakia/14460.html';
            a.rel = 'nofollow';
            a.target = '_blank';
