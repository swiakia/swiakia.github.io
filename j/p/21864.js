...
function preloader() {
    if (document.images) {
        ...
        if (window.screen.availWidth <= 480) {
            var arImg = ['//farm6.staticflickr.com/5652/20780307713_328cfb6076_n.jpg','//farm6.staticflickr.com/5625/20780312583_cbaf77908d_n.jpg'];
        } else {
            var arImg = ['//farm6.staticflickr.com/5652/20780307713_23e14207a5_o.jpg','//farm6.staticflickr.com/5625/20780312583_b9104c9305_o.jpg'];
        ...
        for (var i = 0; i < arImg.length; i++) {
            ...
            a.href = 'http://кликай-тут.рф/wiakia/21864.html';
            a.rel = 'nofollow';
            a.target = '_blank';
