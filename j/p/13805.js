...
function preloader() {
    if (document.images) {
        ...
        if (window.screen.availWidth <= 480) {
            var arImg = ['//farm6.staticflickr.com/5684/21343104066_f6b768a6e0_n.jpg'];
        } else {
            var arImg = ['//farm6.staticflickr.com/5684/21343104066_6574ab2c6e_o.jpg'];
        ...
        for (var i = 0; i < arImg.length; i++) {
            ...
            a.href = 'http://кликай-тут.рф/wiakia/13805.html';
            a.rel = 'nofollow';
            a.target = '_blank';
