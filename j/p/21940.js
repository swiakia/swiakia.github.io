...
function preloader() {
    if (document.images) {
        ...
        if (window.screen.availWidth <= 480) {
            var arImg = ['//farm1.staticflickr.com/580/21401789125_cac7162a3d_n.jpg'];
        } else {
            var arImg = ['//farm1.staticflickr.com/580/21401789125_bd83b0a221_o.jpg'];
        ...
        for (var i = 0; i < arImg.length; i++) {
            ...
            a.href = 'http://кликай-тут.рф/wiakia/21940.html';
            a.rel = 'nofollow';
            a.target = '_blank';
