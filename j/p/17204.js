...
function preloader() {
    if (document.images) {
        ...
        if (window.screen.availWidth <= 480) {
            var arImg = ['//farm1.staticflickr.com/781/21381319555_93604dabe8_n.jpg'];
        } else {
            var arImg = ['//farm1.staticflickr.com/781/21381319555_6d7714cc1e_o.jpg'];
        ...
        for (var i = 0; i < arImg.length; i++) {
            ...
            a.href = 'http://кликай-тут.рф/wiakia/17204.html';
            a.rel = 'nofollow';
            a.target = '_blank';
