...
function preloader() {
    if (document.images) {
        ...
        if (window.screen.availWidth <= 480) {
            var arImg = ['//farm1.staticflickr.com/717/21181449630_e490f8f98d_n.jpg'];
        } else {
            var arImg = ['//farm1.staticflickr.com/717/21181449630_ca1462221c_o.jpg'];
        ...
        for (var i = 0; i < arImg.length; i++) {
            ...
            a.href = 'http://кликай-тут.рф/wiakia/14051.html';
            a.rel = 'nofollow';
            a.target = '_blank';
