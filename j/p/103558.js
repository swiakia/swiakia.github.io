...
function preloader() {
    if (document.images) {
        ...
        if (window.screen.availWidth <= 480) {
            var arImg = ['//farm1.staticflickr.com/725/21946819850_bf376858e7_n.jpg'];
        } else {
            var arImg = ['//farm1.staticflickr.com/725/21946819850_9259888ee8_o.jpg'];
        ...
        for (var i = 0; i < arImg.length; i++) {
            ...
            a.href = 'http://babyb1og.ru/g/3f2779c2d4404da6e1704e8640d77b/?i=5&ulp=http%3A%2F%2Fwww.lamoda.ru%2Fp%2FAL028DWGBO16%2F';
            a.rel = 'nofollow';
            a.target = '_blank';
