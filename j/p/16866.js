...
function preloader() {
    if (document.images) {
        ...
        if (window.screen.availWidth <= 480) {
            var arImg = ['//farm1.staticflickr.com/612/21388306241_fb11f78e62_n.jpg'];
        } else {
            var arImg = ['//farm1.staticflickr.com/612/21388306241_1c2d5fbdc0_o.jpg'];
        ...
        for (var i = 0; i < arImg.length; i++) {
            ...
            a.href = 'http://кликай-тут.рф/wiakia/16866.html';
            a.rel = 'nofollow';
            a.target = '_blank';
